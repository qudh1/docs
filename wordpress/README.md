...
-	[`5.6.0-fpm-alpine`, `5.6-fpm-alpine`, `5-fpm-alpine`, `fpm-alpine`, `5.6.0-php7.4-fpm-alpine`, `5.6-php7.4-fpm-alpine`, `5-php7.4-fpm-alpine`, `php7.4-fpm-alpine`](https://github.com/docker-library/wordpress/blob/af6cc1c9637878a7d3c59c1a451f202533189b96/latest/php7.4/fpm-alpine/Dockerfile)
...
-	[`5.6.0-php7.3-fpm-alpine`, `5.6-php7.3-fpm-alpine`, `5-php7.3-fpm-alpine`, `php7.3-fpm-alpine`](https://github.com/docker-library/wordpress/blob/af6cc1c9637878a7d3c59c1a451f202533189b96/latest/php7.3/fpm-alpine/Dockerfile)
...
-	[`beta-5.6.0-apache`, `beta-5.6-apache`, `beta-5-apache`, `beta-apache`, `beta-5.6.0`, `beta-5.6`, `beta-5`, `beta`, `beta-5.6.0-php7.4-apache`, `beta-5.6-php7.4-apache`, `beta-5-php7.4-apache`, `beta-php7.4-apache`, `beta-5.6.0-php7.4`, `beta-5.6-php7.4`, `beta-5-php7.4`, `beta-php7.4`](https://github.com/docker-library/wordpress/blob/8f5bcc1c980fce198bd191cfb7f51a3e76bb59cd/beta/php7.4/apache/Dockerfile)
-	[`beta-5.6.0-fpm`, `beta-5.6-fpm`, `beta-5-fpm`, `beta-fpm`, `beta-5.6.0-php7.4-fpm`, `beta-5.6-php7.4-fpm`, `beta-5-php7.4-fpm`, `beta-php7.4-fpm`](https://github.com/docker-library/wordpress/blob/8f5bcc1c980fce198bd191cfb7f51a3e76bb59cd/beta/php7.4/fpm/Dockerfile)
-	[`beta-5.6.0-fpm-alpine`, `beta-5.6-fpm-alpine`, `beta-5-fpm-alpine`, `beta-fpm-alpine`, `beta-5.6.0-php7.4-fpm-alpine`, `beta-5.6-php7.4-fpm-alpine`, `beta-5-php7.4-fpm-alpine`, `beta-php7.4-fpm-alpine`](https://github.com/docker-library/wordpress/blob/8f5bcc1c980fce198bd191cfb7f51a3e76bb59cd/beta/php7.4/fpm-alpine/Dockerfile)
-	[`beta-5.6.0-php7.3-apache`, `beta-5.6-php7.3-apache`, `beta-5-php7.3-apache`, `beta-php7.3-apache`, `beta-5.6.0-php7.3`, `beta-5.6-php7.3`, `beta-5-php7.3`, `beta-php7.3`](https://github.com/docker-library/wordpress/blob/8f5bcc1c980fce198bd191cfb7f51a3e76bb59cd/beta/php7.3/apache/Dockerfile)
-	[`beta-5.6.0-php7.3-fpm`, `beta-5.6-php7.3-fpm`, `beta-5-php7.3-fpm`, `beta-php7.3-fpm`](https://github.com/docker-library/wordpress/blob/8f5bcc1c980fce198bd191cfb7f51a3e76bb59cd/beta/php7.3/fpm/Dockerfile)
-	[`beta-5.6.0-php7.3-fpm-alpine`, `beta-5.6-php7.3-fpm-alpine`, `beta-5-php7.3-fpm-alpine`, `beta-php7.3-fpm-alpine`](https://github.com/docker-library/wordpress/blob/8f5bcc1c980fce198bd191cfb7f51a3e76bb59cd/beta/php7.3/fpm-alpine/Dockerfile)
