...
-	[`8.0.1-cli-alpine3.13`, `8.0-cli-alpine3.13`, `8-cli-alpine3.13`, `cli-alpine3.13`, `8.0.1-alpine3.13`, `8.0-alpine3.13`, `8-alpine3.13`, `alpine3.13`, `8.0.1-cli-alpine`, `8.0-cli-alpine`, `8-cli-alpine`, `cli-alpine`, `8.0.1-alpine`, `8.0-alpine`, `8-alpine`, `alpine`](https://github.com/docker-library/php/blob/c70a901d7f8f0bf6e25d1bf07379783f0c8f5a7d/8.0/alpine3.13/cli/Dockerfile)
-	[`8.0.1-fpm-alpine3.13`, `8.0-fpm-alpine3.13`, `8-fpm-alpine3.13`, `fpm-alpine3.13`, `8.0.1-fpm-alpine`, `8.0-fpm-alpine`, `8-fpm-alpine`, `fpm-alpine`](https://github.com/docker-library/php/blob/c70a901d7f8f0bf6e25d1bf07379783f0c8f5a7d/8.0/alpine3.13/fpm/Dockerfile)
-	[`8.0.1-cli-alpine3.12`, `8.0-cli-alpine3.12`, `8-cli-alpine3.12`, `cli-alpine3.12`, `8.0.1-alpine3.12`, `8.0-alpine3.12`, `8-alpine3.12`, `alpine3.12`](https://github.com/docker-library/php/blob/24ccf968d7c975d3145f2884ec5410bb2cef936a/8.0/alpine3.12/cli/Dockerfile)
-	[`8.0.1-fpm-alpine3.12`, `8.0-fpm-alpine3.12`, `8-fpm-alpine3.12`, `fpm-alpine3.12`](https://github.com/docker-library/php/blob/24ccf968d7c975d3145f2884ec5410bb2cef936a/8.0/alpine3.12/fpm/Dockerfile)
...
-	[`7.4.14-cli-alpine3.13`, `7.4-cli-alpine3.13`, `7-cli-alpine3.13`, `7.4.14-alpine3.13`, `7.4-alpine3.13`, `7-alpine3.13`, `7.4.14-cli-alpine`, `7.4-cli-alpine`, `7-cli-alpine`, `7.4.14-alpine`, `7.4-alpine`, `7-alpine`](https://github.com/docker-library/php/blob/c70a901d7f8f0bf6e25d1bf07379783f0c8f5a7d/7.4/alpine3.13/cli/Dockerfile)
-	[`7.4.14-fpm-alpine3.13`, `7.4-fpm-alpine3.13`, `7-fpm-alpine3.13`, `7.4.14-fpm-alpine`, `7.4-fpm-alpine`, `7-fpm-alpine`](https://github.com/docker-library/php/blob/c70a901d7f8f0bf6e25d1bf07379783f0c8f5a7d/7.4/alpine3.13/fpm/Dockerfile)
-	[`7.4.14-zts-alpine3.13`, `7.4-zts-alpine3.13`, `7-zts-alpine3.13`, `7.4.14-zts-alpine`, `7.4-zts-alpine`, `7-zts-alpine`](https://github.com/docker-library/php/blob/c70a901d7f8f0bf6e25d1bf07379783f0c8f5a7d/7.4/alpine3.13/zts/Dockerfile)
-	[`7.4.14-cli-alpine3.12`, `7.4-cli-alpine3.12`, `7-cli-alpine3.12`, `7.4.14-alpine3.12`, `7.4-alpine3.12`, `7-alpine3.12`](https://github.com/docker-library/php/blob/4d752fa012280005e7d18f01092120ab9e2eb35c/7.4/alpine3.12/cli/Dockerfile)
-	[`7.4.14-fpm-alpine3.12`, `7.4-fpm-alpine3.12`, `7-fpm-alpine3.12`](https://github.com/docker-library/php/blob/4d752fa012280005e7d18f01092120ab9e2eb35c/7.4/alpine3.12/fpm/Dockerfile)
-	[`7.4.14-zts-alpine3.12`, `7.4-zts-alpine3.12`, `7-zts-alpine3.12`](https://github.com/docker-library/php/blob/4d752fa012280005e7d18f01092120ab9e2eb35c/7.4/alpine3.12/zts/Dockerfile)
...
-	[`7.3.26-cli-alpine3.13`, `7.3-cli-alpine3.13`, `7.3.26-alpine3.13`, `7.3-alpine3.13`, `7.3.26-cli-alpine`, `7.3-cli-alpine`, `7.3.26-alpine`, `7.3-alpine`](https://github.com/docker-library/php/blob/c70a901d7f8f0bf6e25d1bf07379783f0c8f5a7d/7.3/alpine3.13/cli/Dockerfile)
-	[`7.3.26-fpm-alpine3.13`, `7.3-fpm-alpine3.13`, `7.3.26-fpm-alpine`, `7.3-fpm-alpine`](https://github.com/docker-library/php/blob/c70a901d7f8f0bf6e25d1bf07379783f0c8f5a7d/7.3/alpine3.13/fpm/Dockerfile)
-	[`7.3.26-zts-alpine3.13`, `7.3-zts-alpine3.13`, `7.3.26-zts-alpine`, `7.3-zts-alpine`](https://github.com/docker-library/php/blob/c70a901d7f8f0bf6e25d1bf07379783f0c8f5a7d/7.3/alpine3.13/zts/Dockerfile)
-	[`7.3.26-cli-alpine3.12`, `7.3-cli-alpine3.12`, `7.3.26-alpine3.12`, `7.3-alpine3.12`](https://github.com/docker-library/php/blob/a310c86d0bc7e1be238aca04c8357d76b9c40ef6/7.3/alpine3.12/cli/Dockerfile)
-	[`7.3.26-fpm-alpine3.12`, `7.3-fpm-alpine3.12`](https://github.com/docker-library/php/blob/a310c86d0bc7e1be238aca04c8357d76b9c40ef6/7.3/alpine3.12/fpm/Dockerfile)
-	[`7.3.26-zts-alpine3.12`, `7.3-zts-alpine3.12`](https://github.com/docker-library/php/blob/a310c86d0bc7e1be238aca04c8357d76b9c40ef6/7.3/alpine3.12/zts/Dockerfile)
